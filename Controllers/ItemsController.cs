...
namespace HomeFinder.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ItemType,FormOfLease,Address,ZipCode,City,Price,NrOfRoom,Description,LivingArea,GrossFloorArea,PlotArea,ConstructionYear,ListingDate,ShowingDate,MainImageUrl,Images,BrokerFirstName,BrokerLastName,BrokerEmail")] ItemViewModel item)
        {
